...
export default function Transfer ()
{
    ...
    return (
        <>
            ...
            <View className="flex-row items-center justify-between p-4 bg-[#1c40f2]">
            ...
            <ScrollView className="flex-1 bg-slate-50" showsVerticalScrollIndicator={ false }>
                <View className="mx-4 mt-6 bg-white p-4 rounded-xl shadow-md border border-gray-200">
                ...
                <View className="p-4 mx-4 mt-6 bg-white shadow-md rounded-xl overflow-hidden border border-gray-200 gap-4">
                    <View className="my-2">
                ...
                <TouchableOpacity className="p-4 rounded-xl border border-gray-200 bg-[#1c40f2] m-4" onPress={ handleSubmit }>
                    <Text className="text-white font-bold text-center">Chuyển tiền</Text>
                </TouchableOpacity>
            </ScrollView>
