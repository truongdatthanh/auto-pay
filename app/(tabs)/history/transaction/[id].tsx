...
export default function Transaction() {
    ...
    return (
        <View className="flex-1 bg-slate-50">
            <StatusBar barStyle="light-content" backgroundColor={isExpense ? "#ef4444" : "#10b981"} />
            ...
            >
                ...
                >
                    ...
                    <View className="flex-row justify-between items-center py-2">
                        ...
                        <Text className="text-slate-700 font-medium">{data.date}</Text>
                    </View>
                </Animated.View>
                ...
                >
                    ...
                    <View className="flex-row items-center">
                        <Image 
                            source={{ uri: data.logoBanking }} 
                            className="w-10 h-10 rounded-lg bg-slate-50" 
                            resizeMode="contain" 
                        />
                        <View className="ml-3 flex-1">
                            <Text className="text-slate-700 font-semibold text-base">Trương Thành Đạt</Text>
                            <View className="flex-row items-center">
                ...
                >
                    ...
                    <View className="flex-row items-center">
                        ...
                        />
                        <View className="ml-3 flex-1">
                            <Text className="text-slate-700 font-semibold text-base">{data.name}</Text>
                            <View className="flex-row items-center">
                                <Text className="text-blue-500">{data.STK}</Text>
                                <TouchableOpacity className="ml-1.5 p-0.5">
                                    <MaterialIcons name="content-copy" size={14} color="#3b82f6" />
                                </TouchableOpacity>
                            </View>
