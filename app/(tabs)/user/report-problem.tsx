...
//     const [ activeTab, setActiveTab ] = useState<'faqs' | 'report'>( 'faqs' );
...
//                 <TouchableOpacity
//                     className={ `flex-1 py-4 ${ activeTab === 'faqs' ? 'border-b-2 border-[#1c40f2]' : '' }` }
//                     onPress={ () => setActiveTab( 'faqs' ) }
//                 >
//                     <Text className={ `text-center font-medium ${ activeTab === 'faqs' ? 'text-[#1c40f2]' : 'text-gray-500' }` }>
//                         Câu hỏi thường gặp
//                     </Text>
//                 </TouchableOpacity>

//                 <TouchableOpacity
//                     className={ `flex-1 py-4 ${ activeTab === 'report' ? 'border-b-2 border-[#1c40f2]' : '' }` }
//                     onPress={ () => setActiveTab( 'report' ) }
//                 >
//                     <Text className={ `text-center font-medium ${ activeTab === 'report' ? 'text-[#1c40f2]' : 'text-gray-500' }` }>
//                         Báo cáo vấn đề
//                     </Text>
//                 </TouchableOpacity>
//             </View>
