...
export default function TransactionCard( { id, amount, time, content, date }: TransactionCardProps )
{
    const smartDate = getSmartDateDisplay( date );

    return (
        <>
            <View className="bg-slate-50/20 rounded-2xl z-10 overflow-hidden" style={ {
                // shadowColor: '#000',
                // shadowOffset: {
                //     width: 0,
                //     height: 4,
