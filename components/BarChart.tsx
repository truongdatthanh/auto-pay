...
//         if ( todayTransactions.length === 0 )
//         {
//             return { totalIncome: 0, totalExpense: 0, barData: [], maxValue: 0 };
//         }
//         todayTransactions.forEach( item =>
//         {
...
//         } );
//         const incomeInM = income / 1_000_000;
//         const expenseInM = -expense / 1_000_000;
//         const maxVal = Math.ceil( Math.max( incomeInM, expenseInM ) );
//         return {
//             totalIncome: incomeInM,
//             totalExpense: expenseInM,
//             maxValue: maxVal,
//             barData: [
//                 {
//                     value: expenseInM,
//                     label: 'Chi',
//                     frontColor: '#e74c3c',
//                     topLabelComponent: () => <Text className="text-xs font-semibold text-neutral-800 mb-1">{ expenseInM.toFixed( 1 ) }M</Text>,
...
//                     label: 'Thu',
//                     frontColor: '#2ecc71',
//                     topLabelComponent: () => <Text className="text-xs font-semibold text-neutral-800 mb-1">{ incomeInM.toFixed( 1 ) }M</Text>,
...
//     return (
//         <View className="p-4 rounded-2xl bg-white shadow-md">
//             <View className="flex-row justify-between items-center mb-4">
//                 <View className="flex-row items-center">
//                     <TouchableOpacity onPress={ goToPreviousDay } className="p-2 rounded-md bg-gray-100">
//                         <Ionicons name="chevron-back" size={ 20 } color="#666" />
//                     </TouchableOpacity>
//                     <View className="flex-row items-center mx-2">
//                         <Text className="text-sm font-semibold text-neutral-800">{ formatDate( currentDate ) }</Text>
//                         { isToday( currentDate ) && (
...
//                         ) }
//                     </View>
//                     <TouchableOpacity onPress={ goToNextDay } className="p-2 rounded-md bg-gray-100" disabled={ isToday( currentDate ) }>
//                         <Ionicons name="chevron-forward" size={ 20 } color={ isToday( currentDate ) ? "#ccc" : "#666" } />
//                     </TouchableOpacity>
//                 </View>
//                 <TouchableOpacity onPress={ () => router.replace( "/(tabs)/history/statistics" ) } className="flex-row items-center p-2">
...
//             <Animated.View style={ [ { height: 220, justifyContent: 'center' }, animatedStyle ] }>
//                 { isLoading ? (
...
//                     <View className="flex-1 justify-center items-center">
//                         <MaterialCommunityIcons name="chart-bar" size={ 40 } color="#ccc" />
//                         <Text className="mt-2 text-center text-gray-600">Không có giao dịch nào cho ngày này</Text>
//                     </View>
//                 ) : (
...
//                             />
//                         </View>
//                         <View className="w-[150px] bg-gray-100 rounded-xl p-3 ml-4">
//                             <View className="mb-2">
//                                 <View className="flex-row items-center mb-1">
//                                     <View className="w-2.5 h-2.5 rounded-full bg-green-500 mr-1.5" />
//                                     <Text className="text-xs text-gray-600">Thu nhập</Text>
//                                 </View>
//                                 <Text className="text-sm font-bold text-green-500 mb-0.5">{ formatCurrencyVND( totalIncome * 1_000_000 ) }</Text>
//                                 <View className="flex-row items-center">
//                                     <MaterialCommunityIcons name="arrow-down-bold-circle" size={ 16 } color="#2ecc71" />
//                                     <Text className="text-[11px] text-gray-600 ml-1">{ todayTransactions.filter( t => t.amount > 0 ).length } giao dịch</Text>
//                                 </View>
//                             </View>
...
//                                 </View>
//                                 <Text className="text-sm font-bold text-red-500 mb-0.5">{ formatCurrencyVND( totalExpense * 1_000_000 ) }</Text>
//                                 <View className="flex-row items-center">
