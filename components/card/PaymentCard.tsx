...
export default function PaymentCard ( { id, amount, time }: PaymentCardProps )
{
    return (
        <>
            <Pressable className="bg-blue-50 rounded-lg flex-row justify-between items-center px-4 py-2" onPress={ () => router.push( { pathname: "/transaction/[id]", params: { id } } ) }>
                <View>
